...
class ResNet(nn.Module):
    ...
    def set_skip(self, is_skip: bool):
        for module in self.modules():
            if any(isinstance(module, block) for block in [BasicBlock, Bottleneck]):
                module.is_skip = is_skip
    ...
    def forward(self, input):
        output1 = self.forward1(input) # res
        output2 = self.forward2(input) # plain
        return  output1, output2
    

def resnet18_sim(pretrained=False, **kwargs):
...
def resnet34_sim(pretrained=False, **kwargs):
...
def resnet50_sim(pretrained=False, **kwargs):
...
def resnet101_sim(pretrained=False, **kwargs):
