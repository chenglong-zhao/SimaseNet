...
parser.add_argument('--data', metavar='DIR',  default='/media/hdd/Open_Data/ImageNet/ILSVRC/Data/CLS-LOC',
                    help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet18_rm', choices=model_names,
...
def main():
    ...
    if args.arch == 'resnet18_rm':
        model = resnet18_rm(pretrained=True)
        print('load:', args.arch)
